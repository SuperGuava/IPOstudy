...
- 백엔드
  ...
  - 범용 탐색 API (`/insights/companies`, `/insights/company`, `/insights/templates`, `/insights/overview`, `/insights/compare`, `/insights/report`)
...
- 프론트
  ...
  - Explorer에서 stage/risk 필터 + 요약 KPI + 다중 비교 + 템플릿 기반 초보자 리포트 제공
